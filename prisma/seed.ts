...
async function main() {
  ...
  const homepageModules = [
    ...
    },
    {
      ...
      content: {
        description: "เราคัดสรรเทคโนโลยีที่ดีที่สุด ตั้งแต่เซรามิก เซรามิกนาโน ไปจนถึงกระบวนการสปัตเตอร์โลหะมีค่าหลายชั้น",
      },
      isActive: true,
    },
    {
    ...
    },
    {
      ...
      subtitle: "ประเมินงบประมาณการติดตั้งฟิล์มตามขนาดตารางฟุตของคุณได้อย่างแม่นยำ",
      content: {},
      isActive: true,
    },
    {
